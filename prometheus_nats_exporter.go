...
func main() {
	...
	flag.BoolVar(&opts.GetSServerz, "sserverz", false, "Get streaming server metrics.")
	flag.BoolVar(&opts.GetSClientsz, "sclientsz", false, "Get streaming clients.")
	flag.BoolVar(&opts.GetSChannelsz, "schannelsz", false, "Get streaming channels.")
	flag.BoolVar(&opts.GetSStorez, "sstorez", false, "Get streaming store.")
